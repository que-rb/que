...
describe Que::Job, '.bulk_enqueue' do
  def assert_enqueue(
    expected_queues: ['default'] * 10,
    expected_priorities: [100] * 10,
    expected_run_ats: [Time.now] * 10,
    expected_job_classes: [Que::Job] * 10,
    expected_result_classes: [nil] * 10,
    expected_args:,
    expected_kwargs:,
    expected_tags: [nil] * 10,
    expected_count:,
    &enqueue_block
  )
